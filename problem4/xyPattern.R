...
points(26, 80, col="red", pch="*", cex=2)
points(29, 43, col="red", pch="*", cex=2)
points(34, 13, col="red", pch="*", cex=2)
points(79, 75, col="red", pch="*", cex=2)
points(80, 25, col="red", pch="*", cex=2)
